    ...
    public static void main(String[] args)
       {
        ...
        StudentClassNode newNode = new StudentClassNode( "Bad, Student", 10000, 'X', 0.00123);
        bstTest.insert( newNode );
        ...
        bstTest.removeNode( new StudentClassNode( "", 10000, 'X', 0.00 ) );
        
        
        System.out.println( "\nInorder display:\n" 
                                                 + bstTest.outputInOrder() );
        
        //bstTest.removeNode( newNode );
        //bstTest.removeNode( new StudentClassNode("", 119410, 'M', 0.00 ));
            
        System.out.println(bstTest.search(newNode) + "\n");
        
        //bstTest.removeNode( newNode );
        
        System.out.println(bstTest.search( new StudentClassNode( "", 10000, 'X', 0.00 )) + "\n");
